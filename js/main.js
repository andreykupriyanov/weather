const APIKEY = '34767c86586ebf369eec5c392e19bbef';
      ...
      <div class="card__inner">
        ...
        <div class="card__head">
          ...
          <div class="card__head-right card-param">
            ...
            <span class="card-param-text">
              <span class="card-param-value--temp"></span>
              <sup>o</sup>C
            </span>
          </div>
        </div>
        ...
        <div class="card__footer">
          <div class="card__footer-left card-param">
            <svg
              class="card-param-icon card-param-icon--footer"
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 800 800"
            >
              <path
            ...
            <span class="card-param-text card-param-text--footer">
              <span class="card-param-value--wind"></span>
              m/s
            </span>
          </div>
          <div class="card__footer-right card-param">
            ...
            <span class="card-param-text card-param-text--footer">
              <span class="card-param-value--humidity"></span>
              %
            </span>
          </div>
        </div>
  ...
  setTimeout(async function() {
    ...
    setTimeout(function() {
      ...
      document
        ...
        .classList.add('app__container--top');

      // Смена фона
      $body.style.backgroundImage = `url(img/bg/${data.weather[0].icon}.jpeg)`;
